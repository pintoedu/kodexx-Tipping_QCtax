...
#-----------------------------------------------------------------------
#tip_percentage = (tip_exceptional, tip_good, tip_basic, tip_horrible)
# tip_exceptional = float(meal_price) / 100 * 20
# tip_good = float(meal_price) / 100 * 15
# tip_basic = float(meal_price) / 100 * 10
# tip_horrible = float(meal_price) / 100
